  ...
  url = 'https://www.mayk.fi/tietoa-meista/ruokailu/';
    ...
    request(url, function(error, response, html){
        if(!error){
            ...
            vegedays.each(
              function(i, elem) {
                foodList.vegefood.push({"day": elem.prev.prev.prev.prev.children[0].data.slice(1, -1), "food": elem.children[0].data})
              }
            )
            ...
            meatdays.each(
              function(i, elem) {
                foodList.meatfood.push({"day": elem.prev.prev.children[0].data.slice(1, -1), "food": elem.children[0].data})
              }
            )
